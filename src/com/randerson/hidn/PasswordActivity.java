...
public class PasswordActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (defaults != null)
		{
			...
			defaultNavType = defaults.getData().getBoolean("defaultNavType", false);
		...
		if (firstRun)
		{
			Intent setup = new Intent(this, SignupActivity.class);
		...
		if (PASSWORD_FIELD != null)
		{
			...
			if (PASSWORD.length() == 6)
			{
				...
				if (startMain != null)
				{
					...
					{
						// incorrect password prompt and clear field
					}
